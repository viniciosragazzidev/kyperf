  ...
  useEffect(() => {
    ...
    if (pinSection && pinShowcase) {
      ...
      gsap.fromTo(pinShowcase, 
        { scale: 0.88, rotateX: -12, rotateY: 15, transformPerspective: 1000 },
        {
          scale: 1.04,
          rotateX: 8,
          rotateY: -8,
  ...
  return (
    <SmoothScroll>
      <div ref={containerRef} className="relative min-h-screen text-zinc-300 font-mono bg-zinc-950 overflow-hidden selection:bg-emerald-500/30 selection:text-white">
        ...
        {/* 1. HERO SECTION */}
        <section ref={heroRef} className="relative z-10 min-h-[92vh] flex flex-col justify-center px-6 md:px-12 lg:px-24 py-16 border-b border-white/5">
          {/* Engineering-like float metadata coordinates */}
          <div className="absolute top-8 left-8 hidden lg:block text-[8px] text-zinc-650 tracking-widest uppercase space-y-1">
            <div>[SYS_LOC: PANEL/ROOT_MAIN]</div>
            <div>[COORD: 22.9068° S, 43.1729° W]</div>
            <div className="text-zinc-700">[VER: V0.1.0_PROD]</div>
          </div>

          <div className="absolute top-8 right-8 hidden lg:block text-[8px] text-emerald-500/40 tracking-widest uppercase text-right space-y-1">
          ...
          <div className="hero-reveal inline-flex items-center gap-2 bg-emerald-950/40 border border-emerald-500/20 px-3.5 py-1.5 rounded-full text-[9px] uppercase tracking-widest text-emerald-400 font-bold max-w-fit mb-6">
            <span className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" />
            SaaS Operacional Premium para Oficinas Mecânicas
          </div>

          {/* Cinematic Monospace Titles */}
          <h1 className="hero-reveal text-4.5xl md:text-6.5xl lg:text-8xl font-bold text-white uppercase tracking-tighter leading-none max-w-5xl">
            A EVOLUÇÃO <br />
          ...
          <p className="hero-reveal text-xs md:text-sm text-zinc-400 max-w-2.5xl mt-6 tracking-wide leading-relaxed font-sans dark:text-zinc-400">
          ...
          <div className="hero-reveal mt-8 w-full max-w-lg bg-black/70 border border-white/5 rounded-2xl p-4 font-mono text-xs shadow-2xl relative">
            <div className="flex items-center justify-between border-b border-white/5 pb-2 mb-3">
              ...
              <span className="text-[8px] text-zinc-500 uppercase tracking-widest font-bold">TERMINAL DE COMANDO MOCK</span>
            </div>
          ...
          <div className="hero-reveal mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl border-t border-white/5 pt-8">
            <div className="space-y-1">
              <span className="text-[8px] text-zinc-500 uppercase tracking-wider block font-bold">[OFICINAS_CONECTADAS]</span>
              <span className="text-lg md:text-2xl font-bold text-white font-mono">{connectedOficinas.toLocaleString()}</span>
            </div>
            <div className="space-y-1">
              <span className="text-[8px] text-zinc-500 uppercase tracking-wider block font-bold">[MÉDIA_DE_MENSAGENS_BOT]</span>
              <span className="text-lg md:text-2xl font-bold text-emerald-400 font-mono">+940K/MÊS</span>
            </div>
            <div className="space-y-1">
              <span className="text-[8px] text-zinc-500 uppercase tracking-wider block font-bold">[FATURAMENTO_MÉDIO]</span>
              <span className="text-lg md:text-2xl font-bold text-white font-mono">+32.4% ANUAL</span>
            </div>
            <div className="space-y-1">
              <span className="text-[8px] text-zinc-500 uppercase tracking-wider block font-bold">[COMMITTED_UPTIME]</span>
              <span className="text-lg md:text-2xl font-bold text-emerald-500 font-mono">99.98% OK</span>
            </div>
          </div>

          <div className="hero-reveal flex flex-wrap gap-4 mt-10">
            <Link 
              href="/register" 
              className="h-12 px-6 flex items-center gap-2 bg-emerald-500 text-zinc-950 font-bold uppercase text-xs hover:bg-emerald-400 transition-all rounded-none"
            >
        ...
        {/* 4. CORE MODULES GRID SECTION (NEW CONTENT) */}
        ...
        {/* 5. PIN SHOWCASE: FLUXO DE O.S. CINEMÁTICO (WITH 3D TILT EFFECT) */}
        <section id="showcase" className="pin-section relative z-10 min-h-[200vh] border-b border-white/5 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 px-6 md:px-12 lg:px-24">
            ...
            {/* Left side pinned graphic (with 3D Tilt container) */}
        ...
        {/* FLOATING WHATSAPP BOT STATUS (NEW EFFECT) */}
